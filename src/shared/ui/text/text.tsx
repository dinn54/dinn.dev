...
export const H1F = ({
  ...
  return (
    <Text
      className={`text-p36 tab:text-p46 pc:text-p52 font-bold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H2 = ({
  ...
  return (
    <Text
      className={`text-[clamp(1.75rem,2.1vw,2.5rem)] font-bold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H2F = ({
  ...
  return (
    <Text
      className={`text-p32 tab:text-p36 pc:text-p40 font-bold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H3F = ({
  ...
  return (
    <Text
      className={`text-p28 tab:text-p32 pc:text-p36 font-bold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H4F = ({
  ...
  return (
    <Text
      className={`text-p24 tab:text-p28 pc:text-p32 font-bold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H5 = ({
  ...
  return (
    <Text
      className={`text-[clamp(1.25rem,2.2vw,1.5rem)] font-semibold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H5F = ({
  ...
  return (
    <Text
      className={`text-p20 tab:text-p24 pc:text-p28 font-semibold ${className}`}
    >
      {children}
    </Text>
  );
...
export const H6F = ({
  ...
  return (
    <Text
      className={`text-p18 tab:text-p20 pc:text-p24 font-bold ${className}`}
    >
      {children}
    </Text>
  );
...
export const B1F = ({
  ...
  return (
    <Text
      className={`text-p20 tab:text-p24 pc:text-p28 font-medium ${className}`}
    >
      {children}
    </Text>
  );
...
export const B2F = ({
  ...
  return (
    <Text
      className={`text-p16 tab:text-p20 pc:text-p24 font-medium ${className}`}
    >
      {children}
    </Text>
  );
...
export const B3F = ({
  ...
  return (
    <Text
      className={`text-p14 tab:text-p17 pc:text-p20 font-medium ${className}`}
    >
      {children}
    </Text>
  );
...
export const B4 = ({
  ...
  return (
    <Text
      className={`text-[clamp(0.75rem,3.2vw,1.1rem)] font-medium ${className}`}
    >
      {children}
    </Text>
  );
...
export const B4F = ({
  ...
  return (
    <Text
      className={`text-p12 tab:text-p14 pc:text-p16 font-medium ${className}`}
    >
      {children}
    </Text>
  );
...
export const PlaceholderB1 = ({
  ...
  return (
    <Text
      className={`text-util-input-text text-[clamp(0.875rem,1.75vw,1.125rem)] font-medium ${className}`}
    >
      {children}
    </Text>
  );
