...
export const Text = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <span className={`font-inter font-noto-sans-kr leading-[1.2] dark:text-white ${className}`}>
      {children}
    </span>
  );
};
...
export const H1 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(2.25rem,5vw,3.25rem)] font-bold ${className}`}>
      {children}
    </Text>
  );
};
...
export const H3 = ({ weight, children, className }: { weight: 'bold' | 'semibold'; children: React.ReactNode; className?: string }) => {
  const fontWeight = weight === 'bold' ? 'font-bold' : 'font-semibold';
  return (
    <Text className={`text-[clamp(1.5rem,1.9vw,2.25rem)] ${fontWeight} ${className}`}>
      {children}
    </Text>
  );
};
...
export const H5 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(1.25rem,2.5vw,1.75rem)] font-semibold ${className}`}>
      {children}
    </Text>
  );
};
...
export const H6 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(1.125rem,2vw,1.25rem)] font-bold ${className}`}>
      {children}
    </Text>
  );
};
...
export const B1 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(1.25rem,1.6vw,1.75rem)] font-medium ${className}`}>
      {children}
    </Text>
  );
};
...
export const B2 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(1rem,4.1vw,1.5rem)] font-medium ${className}`}>
      {children}
    </Text>
  );
};
...
export const B3 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(0.875rem,1vw,1.125rem)] font-medium ${className}`}>
      {children}
    </Text>
  );
};
...
export const B4 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(0.75rem,3.2vw,1rem)] font-medium ${className}`}>
      {children}
    </Text>
  );
};
export const B5 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(0.5rem,2.9vw,0.675rem)] font-medium ${className}`}>
      {children}
    </Text>
  )
}
...
export const PlaceholderB1 = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <Text className={`text-[clamp(0.875rem,1.75vw,1.125rem)] font-medium text-util-input-text ${className}`}>
      {children}
    </Text>
  );
};
