...
const ProjectData : ProjectData[] = [
  {
    title: "Dinn.dev",
    description: "주정혁 포트폴리오, 블로그 사이트 입니다.주정혁 포트폴리오, 블로그 사이트 입니다.주정혁 포트폴리오, 블로그 사이트 입니다.",
...
const Projects = () =>{
  ...
  return (
    <PageContainer id="projects-section" className="bg-projects-light dark:bg-projects-dark overflow-x-hidden">
      <div className="flex flex-col w-full h-full justify-center items-center">
        <PageHeader title="Projects" color="bg-projects-light dark:bg-projects-dark" />
        <div className="mt-[5.5rem] tab:mt-[5.75rem] pc:mt-[8rem] flex w-full h-[calc(100%-6rem)] tab:h-[calc(100%-6.25rem)] pc:h-[calc(100%-8.5rem)] px-[8.8%] z-[1] tab:py-2 shrink-0">
          <div className="flex flex-col w-full h-full gap-[0.5vh] tab:gap-6 pc:gap-10 items-center justify-center pb-[20%] tab:pb-[12%] pc:pb-[5%]">
            <div id="projects-cards-container" className=" flex-col flex w-full h-fit overflow-hidden">
              <div ref={projectsRef} className="flex w-[calc(100vw-3rem)] tab:w-[calc(100vw-20%)] pc:w-full h-fit overflow-x-auto scrollbar-hide scroll-smooth snap-x snap-mandatory gap-[2vw]">
            ...
            onClick={() => {
              const cardWidth = document.getElementById("project-card-0")?.clientWidth
              ...
              <span className="text-p12 tab:text-p14 pc:text-p16 text-white">더 보기 →</span>
            </Button>
          </div>
